...
import VideoImage from "../../../assets/video2.png";
        ...
        <div className="grid grid-cols-2 gap-2 relative max-h-[373px] min-w-[100%] bg-[#CF3736] px-3 py-1">
          ...
          <div>
            <div className="flex flex-col gap-5 items-end">
              <img
                src={VideoImage}
                className="max-w-[80%] max-h-full h-[217px] "
                alt=""
              />
              <p className="text-white">
                You can seamlessly swap faces in videos for a variety of
                applications, such as creating social media content, GIF
                face swaps, film and TV production, memes, and advertising.
              </p>
            </div>
          </div>
        </div>
